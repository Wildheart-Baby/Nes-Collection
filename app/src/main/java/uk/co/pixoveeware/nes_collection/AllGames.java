...
public class AllGames extends AppCompatActivity {
    ...
    public void readList(){//the readlist function
        ...
        Cursor c = db.rawQuery("SELECT * FROM eu where " + wherestatement + "", null);//select everything from the database table
...
public void search(){
    ...
    ok.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {//read the quantity from the quantity text box and adds one to the total
            ...
            Intent intent = new Intent(AllGames.this, SearchResults.class);//opens a new screen when the shopping list is clicked
