 ...
 * Use the {@link FavouriteGamesFragment#newInstance} factory method to
...
public class FavouriteGamesFragment extends Fragment {
     ...
     * @return A new instance of fragment FavouriteGamesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FavouriteGamesFragment newInstance(String param1, String param2) {
        FavouriteGamesFragment fragment = new FavouriteGamesFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gameList = viewM.GetGames("favourites");
        indexList = viewM.GetIndex("favourites");
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_favourite_games, container, false);
